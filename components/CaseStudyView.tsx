                ...
                <div ref={containerRef} className="h-full w-full overflow-y-auto no-scrollbar">
                    <div className="relative"> {/* Content Wrapper for Lenis */}
                        ...
                        <div className="fixed top-0 left-0 w-full z-[150] pointer-events-none p-6 md:p-8 flex justify-end text-white">
                            <button
                                onClick={onClose}
                                className="pointer-events-auto p-3 md:p-4 mt-20 md:mt-0 bg-black/50 md:bg-white/20 backdrop-blur-xl rounded-full hover:scale-110 transition-transform border border-white/20 shadow-lg text-white"
