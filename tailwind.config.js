...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        sans: ['"Fira Sans"', 'sans-serif'], // Default body text
        glitz: ['"Glitz"', 'sans-serif'], // Main hero titles only
        figtree: ['"Figtree"', 'sans-serif'], // Subtitles, tags, highlighted text
        display: ['"Figtree"', 'sans-serif'], // Change from Glitz to Figtree for most UI elements
        body: ['"Fira Sans"', 'sans-serif'], // Body text
        mozilla: ['"Fira Sans"', 'sans-serif'], // Mozilla/Fira Sans for details
      },
      colors: {
